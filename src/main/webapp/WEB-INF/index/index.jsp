...
<head>
    ...
    <script src="${basePath}lib/jquery.cookie.js"></script>
    <script src="${basePath}lib/json2.js"></script>
    <script src="${basePath}indexdata.js" type="text/javascript"></script>
        <script type="text/javascript">
                ...
                tab = $("#framecenter").ligerTab({
                    ...
                    { 
                        for (var i = 0; i < tabItems.length; i++)
                        {
                            ...
                            if (o.tabid == tabid)
                            {
                            	tabidStr=tabidStr.replace(o.url, "");
            ...
            {
            	//存在就不添加,过滤没有用
            	if(tabidStr.indexOf(url)!=-1){
            		return ;
            	}
            	tabidStr=tabidStr+url+";";
            ...
            var skin_links = {
                "aqua": "${basePath}lib/ligerUI/skins/Aqua/css/ligerui-all.css",
                "gray": "${basePath}lib/ligerUI/skins/Gray/css/all.css",
                "silvery": "${basePath}lib/ligerUI/skins/Silvery/css/style.css",
                "gray2014": "${basePath}lib/ligerUI/skins/gray2014/css/all.css"
            };
            function pages_init()
            {
            ...
            function loginOut(){
            	$.post("${basePath}common/loginOut","",function(data) {
            	 	var code=data.code;
            		var msg=data.msg;
            		if (code == '0000') {
...
<style type="text/css"> 
    ...
    .space{ color:#E7E7E7;}
    /* 顶部 */ 
    .l-topmenu{ margin:0; padding:0; height:31px; line-height:31px; background:url('${basePath}lib/images/top.jpg') repeat-x bottom;  position:relative; border-top:1px solid #1D438B;  }
    .l-topmenu-logo{ color:#E7E7E7; padding-left:35px; line-height:26px;background:url('${basePath}lib/images/topicon.gif') no-repeat 10px 5px;}
...
<div id="topmenu" class="l-topmenu">
    <div class="l-topmenu-logo">企业管理系统</div>
    <div class="l-topmenu-welcome">
        ...
        <a href="#" onclick="loginOut()" class="l-link2">退出</a>
  ...
  <div id="layout1" style="width:99.2%; margin:0 auto; margin-top:4px; "> 
        ...
        <div position="center" id="framecenter"> 
            <div tabid="home" title="我的主页" style="height:300px" >
                <iframe frameborder="0" name="home" id="home" src="${basePath}welcome.htm"></iframe>
            </div> 
        </div> 
